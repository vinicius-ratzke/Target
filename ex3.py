...
faturamentos_validos = [dia["valor"] for dia in faturamentos if dia["valor"] > 0]
...
dias_acima_media = sum(1 for dia in faturamentos if dia["valor"] > media)

print("Menor valor de faturamento:", menor_valor)
print("Maior valor de faturamento:", maior_valor)
print("Número de dias com faturamento superior à média:", dias_acima_media)
